...
public class GraphGenerator
{
    ...
    public int[,] GenerateCompleteGraph(int nodes, int minWeight, int maxWeight)
    {
    ...
    /// <returns>Macierz sąsiedztwa</returns>
    public int[,] GenerateGraph(int pr, int nodes, int minWeight, int maxWeight)
    {
        int[,] matrix = new int[nodes, nodes];
        Random random = new Random();
    ...
    public Table PrintMatrix(int[,] matrix)
    {
