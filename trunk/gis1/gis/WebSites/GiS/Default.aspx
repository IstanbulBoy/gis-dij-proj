...
<body>
    ...
    <hr />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="Measurement.aspx">Przejdź do strony pomiarów</asp:HyperLink>
    <hr />
    <div>
        <h2>1. Wybór grafu</h2>
        ...
        <asp:Panel ID="pnlLoad" runat="server">        
            ...
            <asp:Label ID="lblXML" runat="server" Text="" ForeColor="Red"></asp:Label>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlGenerate" runat="server" Enabled="false">
            ...
            <asp:Button ID="btnGenerate" runat="server" Text="Generuj" 
    ...
    <div>
        ...
        <br />
        <asp:Button ID="btnGenerateXML" onclick="btnGenerateXML_Click" runat="server" Text="Generuj wynikowy plik XML" Visible="False" />
    </div>
    </form> 
</body>
</html>
